// Evidence corpus for the synthetic-persona demo.
//
// Hand-curated, not machine-ingested. Every entry is tagged so retrieval can
// filter by tier, topic, and persona, and so the UI can show provenance.
//
...
export const CORPUS = [
  // ---------------------------------------------------------------- tier 3
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-risk', 'sanctions', 'verification', 'drafting'],
    personas: ['steven', 'jose', 'bill'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-risk', 'sanctions', 'drafting'],
    personas: ['steven', 'jose'],
  ...
  },
  {
    ...
    personas: ['steven', 'jose', 'bo', 'tanner'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-risk', 'sanctions', 'candour'],
    personas: ['steven', 'jose'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-risk', 'sanctions', 'reputation'],
    personas: ['steven', 'jose', 'bill'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-adoption', 'shadow-it', 'tooling'],
    personas: ['steven', 'bo', 'tanner', 'bill'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-adoption', 'training', 'governance'],
    personas: ['steven', 'bo', 'tanner', 'bill'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['ai-adoption', 'trust', 'privilege', 'security'],
    personas: ['steven', 'jose', 'bill', 'amanda'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['trust', 'verification', 'ai-adoption'],
    personas: ['steven', 'jose'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['privilege', 'workflow', 'time-sink', 'ediscovery'],
    personas: ['steven', 'bo', 'tanner', 'erin'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['workflow', 'coordination', 'ediscovery'],
    personas: ['steven', 'erin', 'vishal'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['economics', 'leverage', 'billing'],
    personas: ['steven', 'jose', 'bo', 'tanner'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['economics', 'pricing', 'billing'],
    personas: ['steven', 'jose', 'amanda'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['economics', 'billing', 'efficiency'],
    personas: ['steven', 'jose'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['procurement', 'build-vs-buy', 'security'],
    personas: ['bill', 'steven'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['procurement', 'pricing', 'budget-authority'],
    personas: ['steven', 'bill', 'amanda'],
  ...
  },
  {
    ...
    kind: 'paraphrase',
    verified: false,
    topics: ['economics', 'compensation', 'incentives'],
    personas: ['steven', 'jose'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['role', 'workflow', 'coordination', 'budget-authority'],
    personas: ['steven'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['ai-adoption', 'ai-risk', 'trust'],
    personas: ['steven'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['trust', 'verification', 'ai-adoption', 'drafting'],
    personas: ['steven', 'jose', 'bo', 'bill'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['procurement', 'buying', 'adoption'],
    personas: ['steven', 'jose', 'bill', 'amanda'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['role', 'procurement', 'security', 'build-vs-buy'],
    personas: ['bill'],
  ...
  },
  {
    ...
    kind: 'synthesis',
    verified: true,
    topics: ['economics', 'insourcing', 'market'],
    personas: ['steven', 'jose', 'amanda', 'bill'],
